...
/*!
 * @file underlay_messagePubSubTypes.cpp
...
UnderlayMessagePubSubType::UnderlayMessagePubSubType() {
...
bool UnderlayMessagePubSubType::serialize(void* data,
...
bool UnderlayMessagePubSubType::deserialize(SerializedPayload_t* payload,
                                            void* data) {
  try {
...
std::function<uint32_t()> UnderlayMessagePubSubType::getSerializedSizeProvider(
    void* data) {
...
void* UnderlayMessagePubSubType::createData() {
  return reinterpret_cast<void*>(new UnderlayMessage());
}

void UnderlayMessagePubSubType::deleteData(void* data) {
  delete (reinterpret_cast<UnderlayMessage*>(data));
}

bool UnderlayMessagePubSubType::getKey(void* data, InstanceHandle_t* handle,
                                       bool force_md5) {
